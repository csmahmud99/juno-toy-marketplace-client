        ...
        <div>
            <div className="mx-3">
                <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <div className="card bg-orange-400 shadow-xl border-4 border-white mb-4 text-justify">
                    ...
                    <div className="card bg-orange-400 shadow-xl border-4 border-white text-justify">
